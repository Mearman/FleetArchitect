 ...
 *  type-checks. Mirrors the fixture in engine.ai-step.unit.test.ts. */
function ship(
...
const EMPTY_DEPLOYMENT: DeploymentReference = {
  attacker: { x: 0, y: 0 },
  defender: { x: 1000, y: 0 },
};
...
function index(ships: readonly SimShip[]): Map<string, SimShip> {
